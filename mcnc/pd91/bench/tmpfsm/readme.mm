...
2 & 3) Benchmarks b and c, found in medium.vpnr and large.vpnr, 
were obtained from industry.  
The providers of the benchmarks wish to
remain anonymous, and they decline to tell what are the functions
of these circuits.

NOTE: definitions of the leaf cells used in the benchmarks are found in
the file "db.vpnr", which is a symbolic link to "../db.vpnr".
